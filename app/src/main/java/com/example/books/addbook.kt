    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.addbook).apply() {
            view.setOnClickListener {
                ...
                var booktoadd=BookData(bookId,view.findViewById<EditText>(R.id.autorET).text.toString(),view.findViewById<EditText>(
                ...
                ref.child(bookId!!).setValue(booktoadd)

                view.findNavController().navigate(R.id.action_addbook2_to_read)
            }
        }
    }
    companion object {
